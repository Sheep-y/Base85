import B85 from './base85.mjs';

function run ( type, base ) {
   if ( ! base ) return QUnit.test( type, ( assert ) => assert.ok( base, type + "exists" ) );

   const rfcE = base.Rfc1924Encoder;
   const rfcD = base.Rfc1924Decoder;
   const z85E = base.Z85Encoder;
   const z85D = base.Z85Decoder;
   const a85E = base.Ascii85Encoder;
   const a85D = base.Ascii85Decoder;
   ...
   QUnit.module( type + "RFC 1942" );
   QUnit.test( type + "RfcSpec", function ( assert ) {
   ...
   QUnit.test( type + "RfcStrEncode", function( assert ) { testStrEncode( assert, rfcE, rfcTests ); } );
   QUnit.test( type + "RfcStrDecode", function( assert ) { testStrDecode( assert, rfcD, rfcTests ); } );
   QUnit.test( type + "RfcEncode", function( assert ) { testByteEncode( assert, rfcE, rfcTests ); } );
   QUnit.test( type + "RfcDecode", function( assert ) { testByteDecode( assert, rfcD, rfcTests ); } );
   QUnit.test( type + "RfcRoundTrip", function( assert ) { testRoundTrip( assert, rfcE, rfcD ); } );
   QUnit.test( type + "RfcWrongData", function( assert ) { testInvalidData( assert, rfcE, rfcD ); } );
   ...
   QUnit.module( type + "Z85" );
   QUnit.test( type + "Z85Spec", function ( assert ) {
   ...
   QUnit.test( type + "Z85StrEncode", function( assert ) { testStrEncode( assert, z85E, z85Tests ); } );
   QUnit.test( type + "Z85StrDecode", function( assert ) { testStrDecode( assert, z85D, z85Tests ); } );
   QUnit.test( type + "Z85Encode", function( assert ) { testByteEncode( assert, z85E, z85Tests ); } );
   QUnit.test( type + "Z85Decode", function( assert ) { testByteDecode( assert, z85D, z85Tests ); } );
   QUnit.test( type + "Z85RoundTrip", function( assert ) { testRoundTrip( assert, z85E, z85D ); } );
   QUnit.test( type + "Z85WrongData", function( assert ) { testInvalidData( assert, z85E, z85D ); } );
   ...
   QUnit.module( type + "Ascii85" );
   QUnit.test( type + "A85Spec", function( assert ) {
   ...
   QUnit.test( type + "A85StrEncode", function( assert ) { testStrEncode( assert, a85E, a85Tests ); } );
   QUnit.test( type + "A85StrDecode", function( assert ) { testStrDecode( assert, a85D, a85Tests ); } );
   QUnit.test( type + "A85Encode", function( assert ) { testByteEncode( assert, a85E, a85Tests ); } );
   QUnit.test( type + "A85Decode", function( assert ) { testByteDecode( assert, a85D, a85Tests ); } );
   QUnit.test( type + "A85RoundTrip", function( assert ) { testRoundTrip( assert, a85E, a85D ); } );
   QUnit.test( type + "A85WrongData", function( assert ) {
...
QUnit.test( "Modular & Global", ( assert ) => assert.notEqual( B85, window.Base85, "Modular != Global" ) );

run( 'Modular ', B85 );
run( 'Global ', window.Base85 );